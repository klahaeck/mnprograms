    ...
    # get the service parameter from the Rails router
      ...
      if omniauth and params[:service]
        ...
        if service_route == 'facebook'
          ...
          omniauth['extra']['user_hash']['first_name'] ? first_name =  omniauth['extra']['user_hash']['first_name'] : first_name = ''
          omniauth['extra']['user_hash']['last_name'] ? last_name =  omniauth['extra']['user_hash']['last_name'] : last_name = ''
            ...
            if auth
              ...
              if email != ''
                ...
                if existinguser
                  ...
                  user = User.new :email => email, :password => SecureRandom.hex(10), :fullname => name, :haslocalpw => false, :role_ids => [4]

                  # add this authentication service to our new user
                  user.services.build(:provider => provider, :uid => uid, :uname => name, :uemail => email)
                  user.build_profile(:firstname => first_name, :lastname => last_name)
